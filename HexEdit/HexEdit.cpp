...
VOID
SetWindowTitleText(_In_z_ PCTSTR Text);
VOID
FileClose(
    VOID
);
...
LRESULT
CALLBACK
WndProc(_In_ HWND hWnd, _In_ UINT message, _In_ WPARAM wParam, _In_ LPARAM lParam
)
{
    RECT rc;
    ...
    case WM_CREATE:
    {
        ...
        // Загрузка текста "Hello" из ресурсов
...
)
{
    ...
    hAccel = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSAPPLICATION));//Локализация
